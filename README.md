...
- **ダークテーマ**: 目に優しく洗練された暗色系UI
- **カスタムフォント**: 
  - 見出し: Space Mono（モダンなモノスペースフォント）
  - 本文: Outfit（読みやすいサンセリフフォント）
- **グラデーション効果**: シアン〜ブルー〜パープルのグラデーション
- **滑らかなアニメーション**: フェードイン、スライド、ホバーエフェクト
- **グラスモーフィズム**: 半透明とぼかしを使った奥行きのあるデザイン
